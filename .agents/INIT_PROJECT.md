...
- **Project Name:** `ball-sync`
- **Description:** `BallSync คือแพลตฟอร์มศูนย์กลางข้อมูลฟุตบอล ที่รวบรวมและซิงค์ข้อมูลจากหลายแหล่ง มาแปลงเป็นข้อมูลที่ครบถ้วน ถูกต้อง และพร้อมใช้งานแบบเรียลไทม์ เพื่อให้นักพัฒนาและผู้ใช้งานในประเทศไทยสามารถเข้าถึงข้อมูลฟุตบอลได้อย่างรวดเร็ว เสถียร และไร้ข้อจำกัดด้าน API`
...
- **Fonts:** `Noto_Sans_Thai` จาก next/font/google
...
3. **Feature Requirements:** ยึดความต้องการและขอบเขตของระบบจากไฟล์ `.agents/FEATURE.md` เสมอ
...
- ออกแบบ Theme และ Mood & Tone ตามที่ระบุ: `Design a clean and minimal SaaS dashboard UI for a football data platform called BallSync. Use a light theme with white and soft gray backgrounds, and blue accents. Focus on readability and structured data presentation. Include tables for matches, API usage stats, and developer-focused components. Style inspired by Stripe, Vercel, and modern SaaS platforms. Minimal, clean, professional, and highly usable.`
...
- เริ่มต้นวางโครงสร้างไฟล์ Presenter, Repository และ UseCases สำหรับ Feature แรกตาม `.agents/skills/create-page/SKILL.md`
